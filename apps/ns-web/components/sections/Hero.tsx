  ...
  return (
    <section ref={ref} className="relative flex h-[100svh] items-end overflow-hidden bg-ink">
      <motion.div style={{ scale }} className="absolute inset-0">
        ...
        <div className="absolute left-1/2 top-1/2 h-[70vh] w-[38vw] max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-b from-stone/40 via-stone/10 to-transparent blur-3xl" />
        <div className="absolute inset-0 bg-gradient-to-t from-ink via-ink/40 to-ink/10" />
      </motion.div>

      <motion.div style={{ y, opacity }} className="relative z-10 w-full px-5 pb-14 sm:px-8 sm:pb-20">
        <p className="mb-4 text-xs uppercase tracking-widest2 text-gold">NS — Chapter One</p>
