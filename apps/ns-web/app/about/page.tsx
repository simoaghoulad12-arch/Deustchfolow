  ...
  return (
    <>
      ...
      <main className="min-h-[80svh] px-5 pb-24 pt-32 sm:px-8 sm:pt-40">
        <p className="text-xs uppercase tracking-widest2 text-gold">About</p>
        ...
        <div className="mt-10 max-w-xl space-y-6 text-sm leading-relaxed text-smoke sm:text-base">
          <p>
            NS is a sportswear identity, not a slogan. It exists for the discipline that happens
            off-camera — the repetition, the quiet consistency, the work no one applauds.
          </p>
          <p>
            The product is the message. Every piece is designed to disappear into the work you do
            in it, not compete with it.
          </p>
        </div>
      </main>
      <Footer />
